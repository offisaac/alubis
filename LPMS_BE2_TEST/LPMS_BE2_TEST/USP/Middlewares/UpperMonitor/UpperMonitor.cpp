...
//          break;
			case 0:data[i] = LPMS1.get_data().calAccZ;
				break;
			case 1: data[i] = LPMS1.get_data().aligGyroZ;
				break;
			case 2: data[i] = LPMS1.get_data().Quaternion1;
				break;
			case 3: data[i] = LPMS1.get_data().angularSpeedZ;
				break;
			case 4: data[i] = LPMS1.get_data().Euler_Pitch;
				break;
      default:break;
	  /* 以上部分用于观察参数曲线 */
    }
